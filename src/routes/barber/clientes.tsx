        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredClients.map((client) => (
            <Sheet key={client.id || client.phone}>
              ...
              <SheetContent
                side="right"
                className="bg-[#0A0A0A] border-l-white/5 w-full sm:max-w-md p-0 overflow-y-auto"
              >
                <SheetHeader className="p-8 border-b border-white/5 bg-white/5">
                  ...
                  <SheetTitle className="text-2xl font-serif font-bold text-center text-white">
                    {client.name}
                  </SheetTitle>
                      ...
                      {clientHistory.map((app) => (
                        ...
                        >
                          <div className="flex justify-between items-start mb-2">
                            ...
                            <span className="text-primary font-serif font-black text-sm">
                              R$ {app.total_price}
                            </span>
                          </div>
