        ...
        {showResetForm ? (
          <>
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-3xl font-serif font-bold tracking-tight">RECUPERAR SENHA</CardTitle>
              <CardDescription className="text-zinc-400">Informe seu e-mail para receber o link</CardDescription>
            </CardHeader>
          ...
          <>
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-3xl font-serif font-bold tracking-tight">ROYAL LOGIN</CardTitle>
