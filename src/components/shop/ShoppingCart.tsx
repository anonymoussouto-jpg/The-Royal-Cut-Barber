...
export function ShoppingCart() {
  ...
  const [checkoutStep, setCheckoutStep] = useState<
    "cart" | "info" | "payment_method" | "payment_pix" | "payment_card" | "success"
  >("cart");
  ...
  useEffect(() => {
    let timer: any;
    if (
      (checkoutStep === "payment_pix" || checkoutStep === "payment_card") &&
      timeLeft > 0 &&
      !isExpired
    ) {
      timer = setInterval(() => {
          ...
          <AnimatePresence mode="wait">
            {checkoutStep === "cart" ? (
                        ...
                        <div className="flex items-center gap-3 mt-3">
                          <div className="flex items-center border border-border/40 rounded-md">
                            <button
                              ...
                              className="p-1 hover:text-primary text-white/50"
                            >
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl h-12 px-4 focus:border-primary outline-none text-white"
                      />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-white/40 uppercase tracking-widest">
                  ...
                  <Button
                    ...
                    className="w-full h-12 bg-primary text-black font-bold mt-4"
                  >
                    Escolher Pagamento
                  </Button>
                </div>
              ...
              <motion.div
                ...
                className="space-y-4"
              >
                <h3 className="text-xl font-bold font-serif text-primary mb-6">
                  Forma de Pagamento
                </h3>
                <div className="grid gap-3">
                  <Button
                    ...
                    className="h-16 justify-start gap-4 bg-white/5 border-white/10 hover:bg-white/10"
                  >
                  ...
                  <Button
                    onClick={() => handleCreateOrder("IN_PERSON")}
                    disabled={isProcessing}
                    className="h-16 justify-start gap-4 bg-white/5 border-white/10 hover:bg-white/10"
                  >
              ...
              >
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-white/40">
                    Pague pelo QR Code abaixo para confirmação automática.
                  </p>
                </div>
                  ...
                  {!isExpired && (
                    <>
                      <Button
                        onClick={copyPix}
                        variant="outline"
                        className="w-full gap-2 border-primary/20 hover:border-primary/50 text-white"
                      >
                        {pixCopied ? (
                      ...
                      <div className="flex items-center justify-center gap-2 pt-2">
                        ...
                        <span className="text-[10px] text-white/40 uppercase tracking-widest font-bold">
                          Monitorando pagamento via realtime...
                        </span>
                      </div>
                    </>
                  )}
              ...
              >
                ...
                <p className="text-[10px] text-white/30 italic">
                  Assim que o pagamento for confirmado, esta tela mudará automaticamente.
                </p>
              </motion.div>
            ) : (
              <motion.div
              ...
              >
                ...
                <p className="text-sm text-white/50 px-4">
                  Seu pedido foi registrado. Estamos preparando tudo para você com excelência.
                </p>
                <Button
                  onClick={closeCart}
        ...
        {checkoutStep === "cart" && items.length > 0 && (
          <SheetFooter className="p-6 border-t border-border/40 bg-card/50 backdrop-blur-xl shrink-0 flex-col gap-4">
            ...
            <Button
              ...
              className="w-full py-6 bg-primary hover:bg-primary/90 text-black font-bold text-lg"
            >
              Finalizar Pedido
            </Button>
          </SheetFooter>
